# Scenario 2
# Reservoir host is randomly assigned
# 3,4,5,7,10 species
# 
# Marjolein Toorians
# 12/2023
...
#boxplot(out.total.Sc2$varPPd)$out
#outlier_values <- boxplot.stats(out.total.Sc2$varPPd)$out
#outlier_index <- which(out.total.Sc2$varPPd %in% c(outlier_values))
#df_filt_Sc2 <- out.total.Sc2[-outlier_index,]
#df_filt_Sc2 <-as.data.frame(df_filt_Sc2)
